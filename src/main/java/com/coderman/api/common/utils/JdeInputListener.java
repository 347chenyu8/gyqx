...
import com.coderman.api.report.service.ExcelDataService;
 ...
 * @Author chenyu
 * @Date 2020-12-07 8:42
 **/

// 有个很重要的点 DemoDataListener 不能被spring管理，要每次读取excel都要new,然后里面用到spring可以构造方法传进去
public class JdeInputListener extends AnalysisEventListener<Object> {
    /**
...
//    }
     ...
     *
     * @param jdeInputService
     */
    public JdeInputListener(ExcelDataService jdeInputService) {
        this.excelDataService = jdeInputService;
    }
    /**
     * 这个每一条数据解析都会来调用
     *
